      ...
      e = {
        ...
        commonResult: function (e, s, r) {
          let n = 0,
            ...
            }).text("Savatcha bo'sh. Siz hech qanday mahsulot qo'shmagansiz").fadeOut(),
            l = t("<div>").attr({
          ...
          if (0 == +n ? o.fadeIn() : o.fadeOut(), r) t("." + l.attr("class")).css("display", "block"),  setTimeout(() => {
            ...
            if (!s) return d.html(`<span>Jami mahsulotlar: </span> ${n} ta`), p.html(`<span>Jami bo'lib: </span> <input name="finalPrice" class="smart-basket__total-cost" type="text" value="${i.toString().replace(/(\d)(?=(\d\d\d)+([^\d]|$))/g, "$1 ")} ${a.smartBasketCurrency}">`), c.append(o).append(l).append(d).append(p), c;
            0 == +n && t("." + o.attr("class")).css("display", "block"), t("." + d.attr("class")).html("<span>Jami mahsulotlar: </span> "), t("." + d.attr("class")).html(`<span>Jami mahsulotlar: </span> ${n}ta `), t("." + p.attr("class")).html("<span>Jami bo'lib: </span> "), t("." + p.attr("class")).html(`<span>jami bo'lib: </span> <input name="finalPrice" class="smart-basket__total-cost" type="text" value="${i.toString().replace(/(\d)(?=(\d\d\d)+([^\d]|$))/g, "$1 ")} so'm">`);}
        },
        ...
        userForm: function () {
          ...
          k.append(u).append(m), s.append(k);
